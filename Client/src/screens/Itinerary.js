...
const Itinerary = ({ tourData, selectedNightsKey }) => {
  ...
  if (!tourData) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-600 text-lg">Tour data not available.</p>
      </div>
    );
  }
        ...
        {activeTab === "itinerary" && (
          <div>
            {itineraryDays.length > 0 ? (
                        ...
                        <div
                          ...
                          onClick={() =>
                            setImageIndices((prev) => {
                              ...
                              newIndices[index] =
                                (newIndices[index] - 1 + dayItem.images.length) % dayItem.images.length;
                              return newIndices;
                            })
                          }
                        >
              ...
              <div className="text-center py-12">
                <p className="text-gray-600 text-lg">No itinerary available for this tour.</p>
              </div>
            )}
          </div>
        )}
